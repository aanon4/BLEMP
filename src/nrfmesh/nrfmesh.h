...
#define SCAN_TIMEOUT              (15 * APP_ADV_INTERVAL / 1000)
#define	CONNECT_SCAN_INTERVAL		  MSEC_TO_UNITS(20, UNIT_0_625_MS)
#define	CONNECT_SCAN_WINDOW			  MSEC_TO_UNITS(20, UNIT_0_625_MS)
#define	CONNECT_TIMEOUT_FIXED		  (2 * APP_ADV_INTERVAL / 1000) // s
#define CONNECT_TIMEOUT_CLIENT    (2 * APP_ADV_INTERVAL / 1000) // s
